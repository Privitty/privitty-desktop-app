;(() => {
  ...
  function ie(n, e) {
    return (
      et || (et = document.createElement('a')),
      (et.href = e),
      n === et.href
    )
  }
    ...
    if (l > 1 && l < 9) {
      if (((t.language = s.slice(0, l)), l < 4)) {
        ...
        for (
          ...
          ;(t.extendedLanguageSubtags.push(s.slice(l + 1, l + 4)),
            (l += 4),
            a++)
        }
      }
  ...
  function On(n) {
    let e,
      t = n[2],
      s = []
    for (let r = 0; r < t.length; r += 1) s[r] = jn(wn(n, t, r))
    return {
      c() {
        e = C('ul')
  ...
  function qs(n) {
    ...
    return {
      c() {
        ;((e = C('li')),
          r.c(),
          g(e, 'class', 'pagefind-ui__result svelte-j9e30'))
      },
      m(l, i) {
        ;(S(l, e, i), r.m(e, null))
      },
  ...
  function Ws(n) {
    let e,
      ...
      h = n[3],
      _ = []
    for (let d = 0; d < h.length; d += 1) _[d] = Vn(In(n, h, d))
  ...
  function Wn(n) {
    let e,
      t = n[2],
      s = []
    for (let r = 0; r < t.length; r += 1) s[r] = Gn(Dn(n, t, r))
    return {
      c() {
        e = C('ul')
        for (let r = 0; r < s.length; r += 1) s[r].c()
  ...
  function Xn(n) {
    let e,
      ...
      a = []
    for (let o = 0; o < i.length; o += 1) a[o] = $n(Yn(n, i, o))
    return {
      c() {
  ...
  function $n(n) {
    let e,
      ...
      p = []
    for (let h = 0; h < m.length; h += 1) p[h] = xn(Zn(n, m, h))
    return {
      c() {
        ;((e = C('details')),
          (t = C('summary')),
      ...
      m(h, _) {
        ;(S(h, e, _),
          ...
          (i.innerHTML = a),
          b(l, o))
        for (let c = 0; c < p.length; c += 1) p[c] && p[c].m(l, null)
        b(e, f)
      },
      p(h, _) {
        if (
  ...
  function ya(n) {
    ...
    return {
      ...
      i(c) {
        if (!o) {
          for (let d = 0; d < p.length; d += 1) U(r[d])
          o = !0
        }
      },
      o(c) {
        for (let d = 0; d < r.length; d += 1) P(r[d])
        o = !1
      },
      d(c) {
...
`)
      ...
      pn = async () => {
        for (; !H; ) (mn(), await new Promise(E => setTimeout(E, 50)))
      },
      gs = async (E, F) => {
        ;(t(16, (fn = E || '')),
